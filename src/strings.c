...
const u8 gText_ExperienceMode[] = _("EXPERIENCE MODE");
const u8 gText_OptionMenuPage[] = _("PAGE");
...
const u8 gText_ExperienceModeParty[] = _("PARTY");
const u8 gText_ExperienceModeBattlers[] = _("BATTLERS");
const u8 gText_OptionMenuPage1[] = _("1");
const u8 gText_OptionMenuPage2[] = _("2");
