...
extern const u8 gText_ExperienceMode[];
extern const u8 gText_OptionMenuPage[];
...
extern const u8 gText_ExperienceModeParty[];
extern const u8 gText_ExperienceModeBattlers[];
extern const u8 gText_OptionMenuPage1[];
extern const u8 gText_OptionMenuPage2[];
